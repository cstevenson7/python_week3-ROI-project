...
class Rental():
    ...
    def __init__(self, incomes, expenses):      
        ...
        """
            Rental requires positional arguments:                     
    ...
    def calculateROI(self, monthly_cash_flow):
        print("\nJust about done!\n")
        bldg_cost = self.inputCheck('building')
        ...
        if type == 'income':
            while True:
                ...
                if ck_income.lower() == 'n':
                    ...
                    print ("\nThe calculator has been cleared, please start again\n")
                    sys.exit(0)
